...
const getUrl = async () => {
  try {
    ...
    let response = await facturaPagada(payload);
          ...
          <div class="col-6">
            <div class="d-block py-1">
              <div class="d-flex justify-content-end">
                <div class="img-div">
                  <img class="img-header-icon my-3 my-md-2 ml-3" src="@/assets/facturas-pagadas.png" alt=" icon">
                </div>
