...
<template>
  <div class="d-flex flex-column">
    <div class="view-content">
      ...
      <main-header
        v-if="
          routeName !== 'share-medic-patient-zerofootprint-view' &&
          routeName !== 'medic-patient-zerofootprint-view' &&
          routeName !== 'medic-patient-zerofootprint-item-view' &&
          routeName !== 'share-v2-patient-zerofootprint-item-view' &&
          routeName !== 'share-v2-patient-zerofootprint-view' &&
    ...
    >
      <div class="d-flex justify-content-center text-footer">
        <p class="text-white p-3 text-copyright">
          Todos los derechos reservados. Hospital Metropolitano - {{ new Date().getFullYear() }}
        </p>
      </div>
    </div>
  </div>
